    ...
    render() {
        ...
        return (
            <div className={`${tableClasses.parentClass} custom-table ${dark ? 'dark' : ''}`}>
                <div className="toolbar d-flex justify-content-end flex-wrap" style={{ marginTop: "-35px" }}>
                    <div className="filter-search-control">
                        ...
                        <button className='d-none d-md-block'><span>Search</span></button>
                    </div>
                    {/* <div className="showing" >{showingLine}</div> */}
                    <div className="showby mx-3">
                        <label>Show</label>
                ...
                <div className="toolbar">
                    ...
                    <div className='inlineBlocks'>
                        <div className="d-flex pt-3 text-right">
